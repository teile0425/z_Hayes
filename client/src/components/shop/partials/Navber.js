...
const Navber = (props) => {
  ...
  return (
    <Fragment >
      {/* Navber Section */}
      <nav className="fixed top-0 w-full z-20 shadow-lg lg:shadow-none bg-white" style={{ background: "#303031", color: "#e25b00" }}>
        <div className="m-4 md:mx-12 md:my-6 grid grid-cols-4 lg:grid-cols-3">
          ...
          <div
            onClick={(e) => history.push("/")}
            style={{ letterSpacing: "0.70rem", color: "#e25b00" }}
                    ...
                    {!isAdmin() ? (
                      <Fragment>
                        <li className="flex flex-col text-gray-700 w-48 shadow-lg">
                          ...
                          <span
                            onClick={(e) => history.push("/wish-list")}
                            className="flex space-x-2 py-2 px-8 hover:bg-gray-400 cursor-pointer" style={{ background: "#e25b00" }}
                          >
                            <span>
                              <svg
                                className="w-6 h-6"
